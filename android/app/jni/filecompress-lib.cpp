...
typedef struct VideoInfo {
    ...
    ~VideoInfo() {
        ...
        if (stream != nullptr) {
            ...
            //DEBUG_DELREF("filecompress-lib.cpp stream");
...
extern "C" JNIEXPORT void JNICALL Java_com_mirrorfly_1rn_newfilecompression_helper_AnimatedFileDrawable_videoprocess(JNIEnv *env, jclass clazz,jint sdkVersion, jstring src, jintArray data) {
    LOGE("NDK_XXX_getVideoInfo-Calling", "JINI");
    ...
    LOGE("NDK_XXX_getVideoInfo-Calling", info);
    int ret;

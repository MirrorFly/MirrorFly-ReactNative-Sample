...
import com.mirrorfly_rn.newfilecompression.compressionhelper.remix.AudioRemixer;
import com.mirrorfly_rn.newfilecompression.compressionhelper.remix.DefaultAudioRemixer;
import com.mirrorfly_rn.newfilecompression.compressionhelper.resample.AudioResampler;
import com.mirrorfly_rn.newfilecompression.compressionhelper.resample.DefaultAudioResampler;
...
public class AudioBufferConverter {
    ...
    public ShortBuffer convert(@NonNull ShortBuffer inputBuffer, int inputSampleRate, int inputChannelCount,
        ...
        // Do the resampling.
        int resampleSize = (int) Math.ceil((double) remixSize * outputSampleRate / inputSampleRate);

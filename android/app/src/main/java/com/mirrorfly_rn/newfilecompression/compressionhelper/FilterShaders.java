...
public class FilterShaders { // NOSONAR

    public static String precision = "precision lowp float;";

    private static final String fragmentragmentShaderCode =
            precision +
    ...
    public boolean create() {
        ...
        fragmentShader = loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentragmentShaderCode);
        vertexShader = loadShader(GLES20.GL_VERTEX_SHADER, simpleVertexShaderCode);
        if (vertexShader != 0 && fragmentShader != 0) {
    ...
    private void loadTexture(Bitmap bitmap, int orientation, int w, int h) {
        ...
        if (bitmap != null && !bitmap.isRecycled()) {
            ...
            float maxSize = Utilities.getPhotoSize();

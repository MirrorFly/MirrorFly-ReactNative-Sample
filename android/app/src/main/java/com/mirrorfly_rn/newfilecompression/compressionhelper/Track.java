...
import com.mirrorflysdk.shadow.media.coremedia.iso.boxes.AbstractMediaHeaderBox;
import com.mirrorflysdk.shadow.media.coremedia.iso.boxes.SampleDescriptionBox;
import com.mirrorflysdk.shadow.media.coremedia.iso.boxes.SoundMediaHeaderBox;
import com.mirrorflysdk.shadow.media.coremedia.iso.boxes.VideoMediaHeaderBox;
import com.mirrorflysdk.shadow.media.coremedia.iso.boxes.sampleentry.AudioSampleEntry;
import com.mirrorflysdk.shadow.media.coremedia.iso.boxes.sampleentry.VisualSampleEntry;
import com.mirrorflysdk.shadow.media.googlecode.mp4parser.boxes.mp4.ESDescriptorBox;
import com.mirrorflysdk.shadow.media.googlecode.mp4parser.boxes.mp4.objectdescriptors.AudioSpecificConfig;
import com.mirrorflysdk.shadow.media.googlecode.mp4parser.boxes.mp4.objectdescriptors.DecoderConfigDescriptor;
import com.mirrorflysdk.shadow.media.googlecode.mp4parser.boxes.mp4.objectdescriptors.ESDescriptor;
import com.mirrorflysdk.shadow.media.googlecode.mp4parser.boxes.mp4.objectdescriptors.SLConfigDescriptor;
import com.mirrorflysdk.shadow.media.mp4parser.iso14496.part15.AvcConfigurationBox;

...
export const VideoUnMuteIcon = ({ width, height, color }) => {
   return (
      <Svg
         xmlns="http://www.w3.org/2000/svg"
         width={width || '54.167'}
         height={height || '54.167'}
         viewBox="0 0 54.167 54.167">
         <G id="video_unmute" data-name="video/ unmute" transform="translate(-198.615 -526.042)">
            <Path
               d="M27.083,0A27.083,27.083,0,1,1,0,27.083,27.083,27.083,0,0,1,27.083,0Z"
               transform="translate(198.615 526.042)"
               fill={'#fff'}
               opacity="0.3"
            />
            <Path
               ...
               transform="translate(215.104 542.5)"
               fill={color || '#fff'}
               stroke={color || '#fff'}
               strokeWidth="0.3"
            />

...
export const EmojiIcon = ({ fill = '', width = '18', height = '18' }) => {
   return (
...
export const KeyboardIcon = props => {
   return (
      <Svg xmlns="http://www.w3.org/2000/svg" height="22px" viewBox="0 0 24 24" width="24px" fill="#A5A5A8">
...
export const BlockedIcon = ({ width = '16', height = '16', fill = '#181818' }) => {
   return (
...
export const ChatsIcon = ({ width, height, fill }) => {
   return (
...
export const UnArchiveIcon = ({ width, height }) => {
   return (
      <Svg
         xmlns="http://www.w3.org/2000/svg"
         width={width || '17.998'}

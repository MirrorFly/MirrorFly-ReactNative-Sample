import { Box, HStack, Icon, Center, IconButton, Pressable, Text, VStack, View, AlertDialog } from 'native-base'
import React from 'react'
import Avathar from '../common/Avathar'
import MenuContainer from '../common/MenuContainer'
import { LeftArrowIcon, UnFavouriteIcon } from '../common/Icons'
import MarqueeText from '../common/MarqueeText'
import { CloseIcon, DeleteIcon, FavouriteIcon, ForwardIcon, MessageInfoIcon, ReplyIcon, SandTimer } from '../common/Icons';
...
function ChatHeader(props) {
    ...
    return (
        <>
            ...
            {props?.selectedMsgs.length<=0 ? (<HStack h={'60px'} bg="#F2F2F2" justifyContent="space-between" alignItems="center" w="full">
             ...
             <>
                ...
                <AlertDialog isOpen={remove} onClose={onClose}>
                    <AlertDialog.Content borderRadius={0}>
                        <AlertDialog.Body  >
                          <Text fontSize={"16"} fontWeight={"400"} px={"2"}>Are you sure you want to delete selected Message ?</Text>  
                            <HStack justifyContent={"flex-end"} py="4" space={4}>

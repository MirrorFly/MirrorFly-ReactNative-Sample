        ...
        <View  borderWidth={props.isSame ? 0 : 0.25}  borderColor={'#959595'} bgColor={props.isSame ? '#E2E8F7' : '#fff'}  borderRadius={5} >
            <View  flex={1} width={210} mx={1.2} my={0.9} height={100} position={"relative"}>
                <View style={{ paddingTop: 12, paddingHorizontal: 10, flexDirection: "row", alignItems: "center" }}>
                    ...
                    <Text style={{ color: "#000", fontSize: 12, fontWeight: "400", paddingLeft: 5 }} >{ContactInfo}</Text>
                </View>
                <HStack style={{ alignItems:"center", justifyContent: "flex-end", flex: 0.8 }}>
                    {props.status}
                    <Text style={{ color: "#000", fontSize: 10, paddingRight: 6}}> {props.timeStamp} </Text>
                </HStack>
                <View style={{ borderWidth: 0.2, borderColor: "#BFBFBF" }} />
                <View style={{ justifyContent: "center", marginTop: 5 }}>
                    <Text style={{ color: "#000", fontSize: 12, fontWeight: "500", textAlign: "center" }}>
                        Invite
                    </Text>
                </View>
            </View>

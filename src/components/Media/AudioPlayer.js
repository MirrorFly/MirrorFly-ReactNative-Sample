...
const AudioPlayer = props => {
   ...
   */
   ...
   const sliderDisable = React.useMemo(() => {
      return !(mediaStatus === mediaStatusConstants.DOWNLOADED || mediaStatus === mediaStatusConstants.UPLOADED);
   }, [mediaStatus]);

   return (
      <View style={style.audioControlContainer}>
         <View flexDirection={'row'}>
            {(mediaStatus === mediaStatusConstants.DOWNLOADED || mediaStatus === mediaStatusConstants.UPLOADED) && (
               <>

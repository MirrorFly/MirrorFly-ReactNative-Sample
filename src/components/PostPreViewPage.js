...
const PostPreViewPage = (props) => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <View style={{ flexDirection: "row", padding: 12, alignItems: "center", justifyContent: 'space-between', backgroundColor: "#F2F2F2", width: "100%", borderBottomColor: "#0000001A", borderBottomWidth: 1, zIndex:10 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }} >
                    <Pressable onPress={handleBackBtn} style={{ marginLeft: 8 }}>
                        <BackArrowIcon />
                    </Pressable>
                    <Text style={{ color: "#000", fontSize: 20, fontWeight: "500", marginLeft: 20 }}>{isSender ? 'Sent' : 'Received'} Media</Text>
                </View>

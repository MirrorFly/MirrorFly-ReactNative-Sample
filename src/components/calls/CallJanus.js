...
const CallJanus = () => {
   ...
   const register = async () => {
      try {
         ...
         const register = await SDK.register('91' + number, fcmToken, token, false);
            ...
            {auth && (
               <View style={{ width: '100%' }}>
                  <TextInput
                     ...
                     placeholder="Enter Phone Number"
                  />
                  <Button style={styles.button} onPress={onMakeCall} title="Make VideoCall" color="#841584" />
                  <Button style={styles.button} onPress={answerCall} title="Answer VideoCall" color="#841584" />
                  <Button style={styles.button} onPress={muteCall} title="Mute VideoCall" color="#841584" />
                  <Button style={styles.button} onPress={unmuteCall} title="Unmute VideoCall" color="#841584" />
                  <Button style={styles.button} onPress={muteAudio} title="Mute Audio" color="#841584" />
                  <Button style={styles.button} onPress={unMuteAudio} title="UnMute Audio" color="#841584" />
                  <Button style={styles.button} onPress={endCall} title="End VideoCall" color="#841584" />
                  {status && (
                     <Text
                        style={{
                           textAlign: 'center',

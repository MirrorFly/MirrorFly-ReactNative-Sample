...
const didChangeAudioRoute = handler => eventEmitter.addListener(RNCallKeepDidChangeAudioRoute, handler);
...
const onHasActiveCall = handler => eventEmitter.addListener(RNCallKeepHasActiveCall, handler);
...
const didLoadWithEvents = handler => eventEmitter.addListener(RNCallKeepDidLoadWithEvents, handler);

const showIncomingCallUi = handler => eventEmitter.addListener(RNCallKeepShowIncomingCallUi, data => handler(data));

const silenceIncomingCall = handler => eventEmitter.addListener(RNCallKeepOnSilenceIncomingCall, data => handler(data));

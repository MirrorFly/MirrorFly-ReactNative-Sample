...
export const RESET_TYPING_STATUS_DATA = 'RESET_TYPING_STATUS_DATA';
...
export const UPDATE_IS_CALL_FROM_VOIP = 'UPDATE_IS_CALL_FROM_VOIP';
export const CLEAR_CALL_DATA = 'CLEAR_CALL_DATA';
export const RESET_CALL_DATA = 'RESET_CALL_DATA';
export const CONFRENCE_POPUP_STATUS = 'CONFRENCE_POPUP_STATUS';
export const UPDATE_CONFRENCE_POPUP_STATUS = 'UPDATE_CONFRENCE_POPUP_STATUS';
...
export const GET_USER_JID = 'GET_USER_JID';
export const ADD_CHAT_CONVERSATION_HISTORY = 'ADD_CHAT_CONVERSATION_HISTORY';
export const UPDATE_CHAT_CONVERSATION_HISTORY = 'UPDATE_CHAT_CONVERSATION_HISTORY';
...
export const ADD_CHAT_SEEN_PENDING_MSG = 'ADD_CHAT_SEEN_PENDING_MSG';
export const SET_XMPP_CONNECTION_STATUS = 'SET_XMPP_CONNECTION_STATUS';
export const UPDATE_USER_PRESENCE = 'UPDATE_USER_PRESENCE';
export const UPDATE_MESSAGE_LIST = 'UPDATE_MESSAGE_LIST';
export const UPDATE_RECENT_CHAT_MESSAGE_STATUS = 'UPDATE_RECENT_CHAT_MESSAGE_STATUS';
export const ADD_GALLERY_ALBUM = 'ADD_GALLERY_ALBUM';
export const ADD_GALLERY_PHOTOS = 'ADD_GALLERY_PHOTOS';
export const ADD_GALLERY_GROUP_NAME = 'ADD_GALLERY_GROUP_NAME';
export const RESET_GALLERY_DATA = 'RESET_GALLERY_DATA';
export const UPDATE_MEDIA_DOWNLOAD_DATA = 'UPDATE_MEDIA_DOWNLOAD_DATA';
export const CANCEL_MEDIA_DOWNLOAD_DATA = 'CANCEL_MEDIA_DOWNLOAD_DATA';
export const UPDATE_MEDIA_UPLOAD_DATA = 'UPDATE_MEDIA_UPLOAD_DATA';
export const CANCEL_MEDIA_UPLOAD_DATA = 'CANCEL_MEDIA_UPLOAD_DATA';
export const UPDATE_SINGLE_CHAT_SELECTED_MEDIA_IMAGE = 'UPDATE_SINGLE_CHAT_SELECTED_MEDIA_IMAGE';
export const RESET_SINGLE_CHAT_SELECTED_MEDIA_IMAGE = 'RESET_SINGLE_CHAT_SELECTED_MEDIA_IMAGE';
export const UPDATE_SAFE_AREA_BG_COLOR = 'UPDATE_SAFE_AREA_BG_COLOR';
export const RESET_SAFE_AREA = 'RESET_SAFE_AREA';
export const RESET_STORE = 'RESET_STORE';
export const DELETE_CONVERSATION = 'DELETE_CONVERSATION';
export const SET_CONVERSATION_SEARCH_TEXT = 'SET_CONVERSATION_SEARCH_TEXT';
export const UPDATE_CONVERSATION_TOTAL_SEARCH_RESULTS = 'UPDATE_CONVERSATION_TOTAL_SEARCH_RESULTS';
export const UPDATE_CONVERSATION_SEARCH_MESSAGE_INDEX = 'UPDATE_CONVERSATION_SEARCH_MESSAGE_INDEX';
export const CLAER_CONVERSATION_SEARCH_DATA = 'CLAER_CONVERSATION_SEARCH_DATA';
export const UPDATE_ROSTER_DATA = 'UPDATE_ROSTER_DATA';
export const RECOVER_MESSAGE = 'RECOVER_MESSAGE';
export const DELETE_RECOVER_MESSAGE = 'DELETE_RECOVER_MESSAGE';
export const UPDATE_CHAT_CONVERSATION_LOCAL_NAV = 'UPDATE_CHAT_CONVERSATION_LOCAL_NAV';
export const TOGGLE_RECENT_CHAT_SEARCH = 'TOGGLE_RECENT_CHAT_SEARCH';
export const UPDATE_RECENT_CHAT_SEARCH_TEXT = 'UPDATE_RECENT_CHAT_SEARCH_TEXT';
export const UPDATE_RECENT_CHAT_SELECTED_ITEMS = 'UPDATE_RECENT_CHAT_SELECTED_ITEMS';
export const UPDATE_RECENT_CHAT_SELECTED_ITEMS_OBJECT = 'UPDATE_RECENT_CHAT_SELECTED_ITEMS_OBJECT';
export const CLEAR_RECENT_CHAT_SELECTED_ITEMS = 'CLEAR_RECENT_CHAT_SELECTED_ITEMS';
...
export const SET_CALL_MODAL_SCREEN = 'SET_CALL_MODAL_SCREEN';
export const UPDATE_CALLER_UUID = 'UPDATE_CALLER_UUID';
export const UPDTAE_CALL_AGAIN_DATA = 'UPDTAE_CALL_AGAIN_DATA';
export const RESET_CALL_AGAIN_DATA = 'RESET_CALL_AGAIN_DATA';
export const SET_NOTIFICATION_DATA = 'SET_NOTIFICATION_DATA';
export const RESET_NOTIFICATION_DATA = 'RESET_NOTIFICATION_DATA';
export const UPDATE_CALL_LAYOUT = 'UPDATE_CALL_LAYOUT';
export const UPDATE_CALL_AUDIO_MUTED = 'UPDATE_CALL_AUDIO_MUTED';
export const UPDATE_CALL_VIDEO_MUTED = 'UPDATE_CALL_VIDEO_MUTED';
export const UPDATE_CALL_SPEAKER_ENABLED = 'UPDATE_CALL_SPEAKER_ENABLED';
export const UPDATE_CALL_WIRED_HEADSET_CONNECTED = 'UPDATE_CALL_WIRED_HEADSET_CONNECTED';
export const UPDATE_SWITCH_CAMERA = 'UPDATE_SWITCH_CAMERA';
export const UPDATE_CALL_BLUETOOTH_HEADSET_CONNECTED = 'UPDATE_CALL_BLUETOOTH_HEADSET_CONNECTED';
export const UPDATE_CALL_SELECTED_AUDIO_ROUTE = 'UPDATE_CALL_SELECTED_AUDIO_ROUTE';
export const UPDATE_DEVICE_AUDIO_ROUTE_STATE = 'UPDATE_DEVICE_AUDIO_ROUTE_STATE';
export const RESET_CALL_CONTROLS_DATA = 'RESET_CALL_CONTROLS_DATA';
export const SHOW_CALL_MODAL_TOAST = 'SHOW_CALL_MODAL_TOAST';
export const RESET_CALL_MODAL_TOAST_DATA = 'RESET_CALL_MODAL_TOAST_DATA';
export const SHOW_PERMISSION_MODAL = 'SHOW_PERMISSION_MODAL';
export const CLOSE_PERMISSION_MODAL = 'CLEAR_PERMISSION_MODAL';
export const ADD_CHAT_CONVERSATION_MESSAGE = 'ADD_CHAT_CONVERSATION_MESSAGE';
export const UPDATE_CHAT_CONVERSATION_MESSAGE = 'UPDATE_CHAT_CONVERSATION_MESSAGE';
export const TOGGLE_SELECT_CHAT_CONVERSATION_MESSAGE = 'TOGGLE_SELECT_CHAT_CONVERSATION_MESSAGE';
export const RESET_SELECT_CHAT_CONVERSATION_MESSAGE = 'RESET_SELECT_CHAT_CONVERSATION_MESSAGE';
export const UPDATE_SENT_SEEN_STATUS = 'UPDATE_SENT_SEEN_STATUS';
export const MESSAGE_HIGHLIGHT = 'MESSAGE_HIGHLIGHT';
export const UPDATE_MESSAGE_BODY_OBJECT = 'UPDATE_MESSAGE_BODY_OBJECT';

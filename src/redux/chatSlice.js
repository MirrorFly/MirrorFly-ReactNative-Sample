...
// export const sendSeenStatus = createAsyncThunk(
//   'chat/sendSeenStatus',
//   async res => {
...
// export const getReceiveMessage = createAsyncThunk(
//   'chat/getReceiveMessage',
//   async (res, { getState }) => {
//     let message = {};
...
// export const sendMediaMsg = createAsyncThunk(
//   'chat/sendMediaMsg',
//   async mediaMsg => {
//     return mediaMsg;
//   },
...
//           },
//         };
//         state.chatMessages[fromUserJId] = [
//           chatMessage,
//           ...state.chatMessages[fromUserJId],
//         ];
//         let fileOptions = {
...
//       switch (res.msgType) {
//         case 'receiveMessage':
//           state.recentChat = state.recentChat
//             .map(user => {
...
//         state.chatMessages = {
//           ...state.chatMessages,
//           [action?.payload?.fromUserJId]: action?.payload?.message?.data,
//         };
//       })
...
//         state.status = 'succeeded';
//         state.chatMessages[action.payload.fromUserJId] = [

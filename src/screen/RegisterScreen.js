...
import { Icon, Modal, Text, Center, Box, useToast, Spinner, HStack, Stack, Input, VStack, Pressable } from 'native-base';
    ...
    return (
        <VStack h='full' justifyContent={'center'}>
            <VStack alignItems={'center'}>
                ...
                <Text color="#767676" fontSize="13" fontWeight="400" textAlign="center">
